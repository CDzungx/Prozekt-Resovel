...
// const Debug = () => {
// 	const hasClickedStartBtn = useStore(hasClickedStartButton);
// 	const dtTheme = useStore(dataTheme);
// 	const languageStore = useStore(locale);
// 	useEffect(() => {
...
// 						<p className="self-center pb-5 text-4xl font-extrabold">
// 							Debug Info
// 						</p>
// 						<div>
// 							<Client>
// 								<div className="prose">
// 									<span className="text-lg font-bold">Data-Theme: </span>{" "}
// 									{dtTheme}
// 								</div>
// 								<div className="prose">
// 									<span className="text-lg font-bold">
// 										Has Start Button Clicked:{" "}
// 									</span>{" "}
// 									{hasClickedStartBtn}
// 								</div>
// 								<div className="prose">
