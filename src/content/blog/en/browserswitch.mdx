...
<div class="relative h-0 pb-[56.25%]">
   <iframe
      src="https://jumpshare.com/embed/rXZfxb3qJogK6gbeYDGN"
      frameborder="0"
      webkitallowfullscreen
      mozallowfullscreen
      allowfullscreen
      class="absolute left-0 top-0 h-full w-full"></iframe>
</div>
### Extensions
...
And, as you may have known, Chrome in particular and Chromium browsers in general, have the most users (>65% of web browser usage), which means a larger community for extension developers.

## Conclusion

Choice is on ya. I'll stay with Firefox because it has features I need, and Brave BAT makes no sense in my country.
