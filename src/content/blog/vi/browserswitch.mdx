...
date: 2023-09-02
description: 'Một câu chuyện về trình duyệt.'
language: vi
...
Mình đã dùng Brave từ lúc nó mới ra mắt, sau đó mình đã thử qua Firefox nhưng do không chuyển dữ liệu từ Brave sang, nên chỉ sau vài ngày mình đã quay lại Brave bởi mình cần lịch sử duyệt web.\
Ngay khi Firefox cập nhật phiên bản 116 mình đã thực hiện việc chuyển toàn bộ dữ liệu từ Brave sang Firefox để thử lại khi trong phiên bản này Firefox đã thêm thanh điều chỉnh âm lượng vào tính năng PiP (Hình trong Hình).

Sử dụng Firefox _Nightly_ trong hai tháng qua, mình sẽ chia sẻ trải nghiệm của mình với bản build _nightly_ của trình duyệt này.
...
Việc chuyển dữ liệu từ Brave sang Firefox không hề dễ dàng. Mình đã phải Google Search một lúc để biết cách chuyển dữ liệu.

### Chuyển lịch sử duyệt web

Vì Firefox không hỗ trợ nhập dữ liệu trực tiếp từ Brave (chắc là các trình duyệt khác cũng không), sau khi tìm tòi, mình đã tìm được một cách để chuyển dữ liệu. Do Firefox hỗ trợ nhập lịch sử từ Edge mà Brave với Edge bản mới đều sử dụng nhân Chromium, mình sẽ copy thủ công lịch sử của Brave sang Edge, rồi từ đó nhập lịch sử của Edge vào Firefox. _Cũng có thể sử dụng Chrome để làm điều tương tự._
...
Có rất nhiều extension trên những trình duyệt nhân Chromium nhưng bởi Firefox có nhân (core) khác biệt, dev phải làm ra một extension (add-on) riêng cho Firefox.\
Và nếu bạn đã biết, Chrome nói riêng và những trình duyệt Chromium nói chung có một cộng đồng rất lớn(>65% lượt sử dụng trình duyệt, 15% nữa là Safari) nên có một cộng đồng rất lớn để phát triển extension.
...
Lựa chọn là ở bạn. Mình sẽ chọn Firefox vì có những tính năng mà mình cần và Brave BAT không có nghĩa lý gì ở Việt Nam. Nhưng nếu bạn chủ yếu dùng trình duyệt trên điện thoại thì nên dùng Brave/Edge hơn.
